...
<head>
    ...
    <style>
        ...
        .search-container {
            margin-bottom: 20px; /* 検索窓の下に余白を追加 */
        }
        input[type="text"] {
            width: 300px;
            padding: 10px;
        ...
        iframe {
            margin-top: 20px;
            width: 794px; /* 幅を794ピクセルに設定 */
            height: 445px; /* 高さを445ピクセルに設定 */
            display: block; /* ブロック要素にして中央寄せにする */
            margin-left: auto;
            margin-right: auto;
        ...
        .result {
            ...
            cursor: pointer;
            width: calc(25% - 20px); /* 幅を25%に設定し、マージンを考慮 */
...
<body>
    ...
    <div class="search-container">
        <input type="text" id="searchInput" placeholder="URLまたはタイトルの一部を入力">
        <button onclick="searchVideo()">検索</button>
    </div>
